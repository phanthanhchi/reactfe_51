...
//giai phap 1 su dung lifecycle componentwillreceiveprop
//ham nay chay khi props thay doi va trc khi render
componentWillReceiveProps(newProps){
//khibamnut sua =>props tha doi ta lay props tu nguoi dung chinh sua (this.props.nguoiDungChinhSua)
//ta gan vao state cua component => va cho render render value tu state
this.setState({
            ...
            <div className="col-12">
              ...
              type="button"
                ...
                onClick={() => {
                  ...
                  // let action = {
                  //   type: "XOA_NGUOI_DUNG",
                  //   maNguoiDung: this.state,
                  //   maNguoiDungXoa,
                  // };
                  this.props.dispatch(xoaNguoiDungAction(this.props.nguoiDung.maNguoiDung))
                }}
              >
                Xóa
              </button>
